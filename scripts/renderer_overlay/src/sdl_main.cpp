/*
    ...
    Headless overlay: removes the X11/GLX SDL_SysWMinfo path so this file
    builds without X11 dev headers. The X11 handoff was only used by the
    OpenXR/VR path, which is also disabled in this build. Desktop rendering
    via SDL2 (including SDL_VIDEODRIVER=offscreen) is unaffected.
*/
